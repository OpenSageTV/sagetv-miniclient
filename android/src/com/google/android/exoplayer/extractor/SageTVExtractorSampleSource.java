 ...
 */
public final class SageTVExtractorSampleSource implements SampleSource, SampleSourceReader,
        ExtractorOutput, Loader.Callback {

    public static boolean FORCE_DISCONTINUITY_READ = false;

    public static SageTVExtractorSampleSource INSTANCE = null;
     ...
     */
    @Deprecated
    public SageTVExtractorSampleSource(Uri uri, DataSource dataSource, int requestedBufferSize,
     ...
     *                            priority. If omitted, the default extractors will be used.
     */
    public SageTVExtractorSampleSource(Uri uri, DataSource dataSource, Allocator allocator,
    ...
    public int readData(int track, long playbackPositionUs, MediaFormatHolder formatHolder,
        ...
        if (FORCE_DISCONTINUITY_READ) {
            System.out.println("Forcing Discontinuity Read");
            FORCE_DISCONTINUITY_READ = false;
...
//        System.out.println("TIMEUS: " + sampleHolder.timeUs);
//        sampleTimeOffsetUs=sampleHolder.timeUs;
//        lastSeekPositionUs=sampleHolder.timeUs;
//        playbackPositionUs=sampleHolder.timeUs;
//        lastSeekPositionUs=sampleHolder.timeUs;
//        downstreamPositionUs = sampleHolder.timeUs;
//        lastSeekPositionUs = sampleHolder.timeUs;
